...
public class SkippingRope extends Machine {
  ...
  public SkippingRope(int cashPerMinute, int caloriesPerMinute,
      int exerciseTime, String name, int frequencyPerMinute) {
  ...
  public String doExercise() {
    return "You have to do this exercise ("
        + "" + this.getName() + ") for " + this.getExerciseTime()
